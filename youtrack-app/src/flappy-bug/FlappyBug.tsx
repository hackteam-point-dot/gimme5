...
export const FlappyBug: React.FC<{
    ...
    return (
      ...
      >
        ...
        >
          ...
          {sprints.map((sp, i) => (
            <React.Fragment key={i}>
              ...
              <div style={{
                            position: 'absolute',
                            left: sp.x,
                            top: sp.gapTop + SPRINT_GAP,
                            width: sp.width,
                            height: GAME_HEIGHT - (sp.gapTop + SPRINT_GAP),
                            display: 'flex',
                            flexDirection: 'column',
                            padding: '4px',
                            boxSizing: 'border-box'
          ...
          {gameState === 'start' && (
            ...
            >
              ...
              <div style={{fontSize: '10px', marginBottom: '2px', color: '#555'}}>Navigate through the Gantt
                chart
              </div>
        ...
        {/* End of inner scalable game wrapper */}
      </div>
    );
};
